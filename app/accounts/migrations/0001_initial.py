# Generated by Django 3.2.8 on 2023-04-30 21:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('intl_phonenumber', app.core.utils.fields.AppCharField(default=None, max_length=15)),
        ...
        migrations.AddIndex(
            model_name='passcode',
            index=models.Index(fields=['intl_phonenumber'], name='accounts_pa_intl_ph_d89114_idx'),
        ),
        migrations.AddIndex(
